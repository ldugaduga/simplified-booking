...
- [x] 7. **Production readiness** - production `.env` template, security settings (HTTPS, secure cookies, debug off), and a VPS deploy checklist with queue worker and cron
